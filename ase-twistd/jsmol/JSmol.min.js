...
function(a){D.consoleOutput(a,"red")};aa.err.println=function(a){D.consoleOutput("undefined"==typeof a?"\r\n":null==a?"null\r\n":a+"\r\n","red")};aa.err.write=function(a,b,c){aa.err.print(String.instantialize(a).substring(b,b+c))}}(Clazz,Jmol))};Jmol.___JmolDate="$Date: 2017-11-07 21:59:50 -0600 (Tue, 07 Nov 2017) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.24.2";
